...
class GymFilter extends React.Component {
  ...
  render() {
    ...
    let dayList = this.props.filteredWorkoutList.filter(
      workout => this.props.gym === workout.gym || this.props.gym === 'all'
    );
    ...
    return (
      <div>
        ...
        <div className='skills'>
          ...
          <DaysFilter dayList={dayList} days={this.state.days} />
        </div>
      </div>
    );
  }
